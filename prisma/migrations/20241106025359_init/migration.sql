...
CREATE TABLE `Session` (
    ...
    UNIQUE INDEX `Session_provider_providerAccountId_key`(`provider`, `providerAccountId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Order` (
    `id` VARCHAR(191) NOT NULL,
    `stripedId` VARCHAR(191) NOT NULL,
    `userId` VARCHAR(191) NOT NULL,
    ...
    UNIQUE INDEX `Order_stripedId_key`(`stripedId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
